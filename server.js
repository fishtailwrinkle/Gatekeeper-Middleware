...
function gateKeeper(req, res, next) {
  ...
  const reqHeader = req.get('x-username-and-password');
  const parser = queryString.parse(reqHeader);
  //console.log(queryString.parse(reqHeader));

  const username = parser.user || null;
  const password = parser.pass || null;
  ...
  //console.log(`userIndex is ${userIndex.password}`);
